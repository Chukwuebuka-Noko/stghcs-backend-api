...
class ManagerAssignGigController extends Controller
{
    ...
    public function index()
    {
        ...
        if ($assign_gig->isEmpty()) {
            return response()->json(['status'=>200,'response'=>'Not Found','message'=>'Assigned Gig(s) does not exist', 'data' => $assign_gig], 200);
        }
        ActivityLog::create([
